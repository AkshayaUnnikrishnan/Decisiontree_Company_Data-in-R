...
mean(train$Sales==pred_train) # 95.43% Accuracy
...
mean(pred_test==test$Sales) # 79.24% accuracy 

confusionMatrix(pred_test,test$Sales)
#This train model is giving us 79.2% accuracy with error rate of 73% 
...
#This doesnt really improve our classification as accuracy dips down to 70%
